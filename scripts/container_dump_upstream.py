...
from cadcoder.objtools import get_obj_all_upstreams
...
def main():
    ...
    for obj in sorted_objects:
        get_obj_all_upstreams(doc, obj, useLabel=useLabel, printDetail=True, prefix=str(i), typePattern='PartDesign::Body')
        print()
        i += 1
