...
class npt_m(baseClass):
    def __init__(self, instanceName, doc, objPrefix="", useLabel=True, importer=None, diaExpansion='0 in', male_height='0.3 in', nominalOD='`1/16',  ):
        ...
        geo0 = sketch.addGeometry(Part.LineSegment(Vector (3.225525053154272, -0.04810161662455155, 0.0), Vector (4.015787037038497, -0.5043608758844058, 0.0)))
        geo1 = sketch.addGeometry(Part.LineSegment(Vector (4.015787037038497, -0.5043608758844058, 0.0), Vector (4.015787037038497, 0.40815764263232523, 0.0)))
        geo2 = sketch.addGeometry(Part.LineSegment(Vector (4.015787037038497, 0.4081576426323253, 0.0), Vector (3.225525053154272, -0.04810161662455148, 0.0)))
