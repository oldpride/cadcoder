...
class npt_straight_bushing(baseClass):
    def __init__(self, instanceName, doc, objPrefix="", useLabel=True, importer=None, b_diaExpansion='-0.02 in', b_male_height='0.5 in', b_nominalOD='`3/4', prism_polygon_height='0.2 in', prism_polygon_sides=6, s_effective_height='0.45 in', s_holeDiaExpansion='0.03 in', s_pitch='0.0357 in', s_radius='0.25 in',  ):
        ...
        b_npt_m_instance.common_boolean.Visibility = False
        ...
        prism_polygon_instance.body.Placement = Placement(Vector(0.0000, 0.0000, -5.0800), Rotation(0.0000, 0.0000, 0.0000, 1.0000))
        from parts.straight_m import straight_m
        s_straight_m_instance = straight_m('s_straight_m_instance', doc, objPrefix=self.objPrefix + 's_straight_m_', useLabel=True, importer=self, diaExpansion='0.03 in', height='0.7000000000000001 in', pitch='0.0357 in', radius='0.265 in')
        ...
        s_straight_m_instance.body.Placement = Placement(Vector(0.0000, 0.0000, -5.0800), Rotation(0.0000, 0.0000, 0.0000, 1.0000))
        ...
        callsheet.set('A10', 's_pitch')
        callsheet.set('A11', 's_radius')
        callsheet.set('A12', 's_holeDiaExpansion')
        callsheet.set('A13', 'bottom_cone_cutter_s_radius')
        callsheet.set('A14', 'bottom_cone_cutter_height')
        callsheet.set('A2', 'b_diaExpansion')
        callsheet.set('A3', 'b_male_height')
        callsheet.set('A4', 'b_nominalOD')
        callsheet.set('A5', 'prism_polygon_height')
        callsheet.set('A6', 'prism_polygon_sides')
        callsheet.set('A7', 's_cutter_height')
        callsheet.set('A8', 's_effective_height')
        callsheet.set('A9', 's_cutter_placement_z')
        callsheet.set('B1', 'value')
        callsheet.set('B10', '=0.0357 in')
        callsheet.setAlias('B10', 's_pitch')
        callsheet.set('B11', '=0.25 in')
        callsheet.setAlias('B11', 's_radius')
        callsheet.set('B12', '=0.03 in')
        callsheet.setAlias('B12', 's_holeDiaExpansion')
        callsheet.set('B13', '=0.27 in')
        callsheet.setAlias('B13', 'bottom_cone_cutter_s_radius')
        callsheet.set('B14', '=0.25000000000000006 in')
        callsheet.setAlias('B14', 'bottom_cone_cutter_height')
        ...
        callsheet.set('B5', '=0.2 in')
        callsheet.setAlias('B5', 'prism_polygon_height')
        callsheet.set('B6', '6')
        callsheet.setAlias('B6', 'prism_polygon_sides')
        callsheet.set('B7', '=0.7000000000000001 in')
        callsheet.setAlias('B7', 's_cutter_height')
        callsheet.set('B8', '=0.45 in')
        callsheet.setAlias('B8', 's_effective_height')
        callsheet.set('B9', '=-0.2 in')
        callsheet.setAlias('B9', 's_cutter_placement_z')
        ...
        callsheet.set('D6', ' number of sides of a polygon')
        callsheet.set('D7', 'thread cutter length')
        callsheet.set('D8', 'thread in-use length')
        ...
        s_straight_m_instance.callsheet.set(s_straight_m_instance.callsheet.getCellFromAlias('radius'), f"=<<{self.addPrefix('callsheet')}>>.s_radius + <<{self.addPrefix('callsheet')}>>.s_holeDiaExpansion / 2")
...
def main():
    ...
    myInstance = npt_straight_bushing("myInstance", doc, objPrefix="", useLabel=True, importer=None, b_diaExpansion='-0.02 in', b_male_height='0.5 in', b_nominalOD='`3/4', prism_polygon_height='0.2 in', prism_polygon_sides=6, s_effective_height='0.45 in', s_holeDiaExpansion='0.03 in', s_pitch='0.0357 in', s_radius='0.25 in', )
